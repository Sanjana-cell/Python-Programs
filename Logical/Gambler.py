"""Program to simulate a gambler who start with $stake and place fair $1 bets until
...
class Gambler:
    ...
    def playGame(self):
        ...
        print("Percentage of game lost=",100.0 * loss / trials) #calculates loss percentage
